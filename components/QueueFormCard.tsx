    ...
    <div className="">
      <div className="border border-gray-300 rounded-md shadow-lg card p-3 w-full ">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              <button className="bg-black text-white px-2 py-1 rounded-md mr-2 shadow-md text-[12px] md:text-base font-joseph-sans">
                Upload
              </button>
        ...
        <div className="flex justify-end ">
          <button className="bg-black text-white px-2 py-1 rounded-md text-[12px] md:text-base shadow-md font-joseph-sans">
            Add to Queue
          </button>
        </div>
      </div>
